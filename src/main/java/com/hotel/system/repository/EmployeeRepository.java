...
public class EmployeeRepository {
    ...
    public Long addEmployee(String firstName, String middleName, String lastName, String phone, String position, Long hotelId) {
        SimpleJdbcCall jdbcCall = new SimpleJdbcCall(jdbcTemplate).withProcedureName("sp_add_employee");
        ...
        inParams.put("p_position", position);
        inParams.put("p_hotel_id", hotelId);
        inParams.put("p_new_emp_id", null);

        Map<String, Object> out = jdbcCall.execute(inParams);
        return ((Number) out.get("p_new_emp_id")).longValue();
    }
